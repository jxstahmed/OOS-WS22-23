...
public class PaymentTest {
    ...
    public static void setUp() {
        System.out.println("Erstelle einige Payments");
        try {
    ...
    public void toStringTester() {
        String string = "Datum: 23.09.1897, Beschreibung: Payment 02, Betrag: -3750.0 €, Incoming Interest: 0.8, Outgoing Interest: 0.5\n";
