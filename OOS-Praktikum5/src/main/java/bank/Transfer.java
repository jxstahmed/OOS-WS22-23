...
public class Transfer extends Transaction
{
     ...
     */
    public Transfer(String datum, String beschreibung, double betrag) throws BetragException
    {
     ...
     */
    public Transfer(String datum, String beschreibung, double betrag, String absender, String empfänger) throws BetragException
    {
     ...
     */
    public Transfer(Transfer neuerTransfer) throws BetragException
    {
    ...
    {
        return super.toString() + ", Sender: " + sender + ", Empfänger: " + recipient + "\n";
    }
