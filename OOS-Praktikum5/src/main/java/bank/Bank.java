...
public interface Bank {
    ...
    void createAccount(String account, List<Transaction> transactions)
            throws AccountAlreadyExistsException, TransactionAlreadyExistException, TransactionAttributeException, ZinsenException;
    ...
    void addTransaction(String account, Transaction transaction)
            throws TransactionAlreadyExistException, AccountDoesNotExistException, TransactionAttributeException, ZinsenException;
    ...
    void removeTransaction(String account, Transaction transaction)
            throws AccountDoesNotExistException, TransactionDoesNotExistException, ZinsenException;
    ...
    boolean containsTransaction(String account, Transaction transaction)
        throws ZinsenException, AccountDoesNotExistException;
